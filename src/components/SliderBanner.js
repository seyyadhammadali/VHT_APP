...
// const SliderBanner = ({ navigation, sliders, loading }) => {
//   const flatListRef = useRef(null);
//   const currentIndex = useRef(0);
...
//       showsHorizontalScrollIndicator={false}
//       renderItem={({ item }) => (
//    <TouchableOpacity onPress={() => navigation.navigate('PakageDetails', {packageType:"slug", typeValue: (item.title.includes('holiday-package') ? item.title.replace(/\/$/, '').split('/').pop()  : null)})}> 
//         <View style={{ marginHorizontal: 10 }} >
//           <FastImage
//             source={{
//               uri: item.mid,
