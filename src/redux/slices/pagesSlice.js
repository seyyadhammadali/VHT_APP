...
//   }
// );
// export const fetchSpecialOfferPage = createAsyncThunk(
//   'pages/fetchSpecialOfferPage',
//   async (id, thunkAPI) => {
//     try {
//       const res = await api.get('single_page?slug=holiday-deal');
//       return res.data;
//     } catch (err) {
//       // console.log('Single Page Error:', err.message);
//       return thunkAPI.rejectWithValue(err.message);
...
//       })
//       // Single Page
//       .addCase(fetchSpecialOfferPage.pending, (state) => {
//         state.loading = true;
//       })
//      .addCase(fetchSpecialOfferPage.fulfilled, (state, action) => {
//           state.specialOfferPage = action.payload.data; // not entire payload
//           state.loading = false;
//         })
 
//       .addCase(fetchSpecialOfferPage.rejected, (state, action) => {
//         state.loading = false;
//         state.error = action.payload;
//       })
//        // 🚢 Single Cruise Page
...
// // Selectors
// export const selectSpecialOfferPage = (state) => state.pages.specialOfferPage;
