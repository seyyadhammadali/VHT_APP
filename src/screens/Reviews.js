...
export default function Reviews({ navigation }) {
  ...
  const onVideoEnd = () => setPlayingVideo(null);
  const onVideoLoad = () => setLoadingVideo(false);
  const onVideoError = (error) => {
    console.log('Video error:', error);
    setPlayingVideo(null);
    setLoadingVideo(false);
  ...
  const renderVideoItem = ({ item }) => {
    ...
    return (
      ...
      //       onError={onVideoError}
      //       onMessage={(event) => {
      //         if (event.nativeEvent.data === 'videoEnded') onVideoEnd();
      //       }}
      //     />
      //   ) : (
      ...
      //   {/* <Image source={logo} style={styles.videoLogo} /> */}
      //   {!isPlaying && (
      //     <TouchableOpacity style={styles.playButton} onPress={() => handleVideoPress(item.id)}>
      //       <Image source={redPlayButton} style={styles.playImage} />
      //     </TouchableOpacity>
      //   )}
      // </View>
